...
### 6-2. LLM の利用
  * LLM は以下のシーンで利用
    1. 事前プロンプトとユーザーからのロボット動作指示プロンプトに基づく、ロボットを操作するための、rclpy ベースのコード生成
    2. API Token 使用料も表示


### 6-3 LLM API プロバイダー比較
...
### 6-5. UI/ユーザープロンプト設計
  ...
  * ロボット操作指示のユーザープロンプト入力し、コード生成した後、生成されたコードを自動実行する
    * ユーザープロンプトの入力後のコード生成中<br>
    ![UI_1](images/UI_1.png)

    * コード生成が完了すると、コードが実行され、Gazebo上での確認を促される<br>
    ![UI_2](images/UI_2.png)

    * コード生成完了後、利用したAPIトークン数を表示<br>
